...
revoke all on function public.sincronizar_icl_bcra(date, date)
  from public, anon, authenticated;
grant execute on function public.sincronizar_icl_bcra(date, date)
  to service_role;
...
begin
  ...
  perform cron.schedule(
    ...
    '15 6 * * *',
    'select public.sincronizar_icl_bcra();'
  );
end;
$$;
